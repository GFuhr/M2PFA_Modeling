...
cdef void triband_dot(const double[:,::1] band_matrix,
                      ...
                      const int matrix_size) nogil noexcept:
    cdef Py_ssize_t idx
    cdef double xm1
    cdef double xi
    cdef double xp1
...
@cython.initializedcheck(False)
@cython.nonecheck(False)
cdef double single_vec_dot(const double[::1] x, const Py_ssize_t vec_size) nogil noexcept:
    cdef double dot = 0.
    cdef Py_ssize_t idx = 0
...
cdef double vec_dot(const double[::1] x, const double[::1] y,
                    const Py_ssize_t vec_size) nogil noexcept:
    cdef double dot = 0.
    cdef Py_ssize_t idx = 0
...
@cython.initializedcheck(False)
@cython.nonecheck(False)
cdef void vec_xmy(double[::1] res, const double[::1] x, const double[::1] y, const Py_ssize_t vec_size) nogil noexcept:
    cdef Py_ssize_t idx = 0
    cdef Py_ssize_t idx_end = vec_size & ~3
...
@cython.initializedcheck(False)
@cython.nonecheck(False)
cdef void vec_xpby(double[::1] res, const double[::1] x, const double[::1] y, const double factor, const Py_ssize_t vec_size) nogil  noexcept:
    cdef Py_ssize_t idx = 0
    cdef Py_ssize_t idx_end = vec_size & ~3
...
@cython.initializedcheck(False)
@cython.nonecheck(False)
cdef void dcopy(const Py_ssize_t vec_size, const double[::1] src, double[::1] dest) nogil noexcept:
    cdef Py_ssize_t idx = 0
    cdef Py_ssize_t idx_end = vec_size & ~3
